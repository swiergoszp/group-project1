            ...
            if (doc.exists) {
                ...
                pages.forEach(function(item, id) {
                    if (id > 0) {
                        ...
                        element = $(tagStyle);
                        $("#book-content").turn("addPage", element, pgCounter + 3)
                    ...
                    $("#book-content").turn("addPage", element, page + 3);
                })
            } else {
...
//***************************************************************/
    ...
    $("#current-book").css("display", "block");
...
//***************************************************************/
$("#book-content").bind("turning", function(event, page) {
//***************************************************************/
